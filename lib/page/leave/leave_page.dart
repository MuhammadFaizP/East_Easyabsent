...
class _LeavePageState extends State<LeavePage> {
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(color: Color.fromARGB(255, 0, 84, 152), style: BorderStyle.solid, width: 1),
                    ),
                                      ...
                                      return Theme(
                                        data: Theme.of(context).copyWith(
                                          colorScheme: const ColorScheme.light(onPrimary: Colors.white,
                                              onBackground: Colors.white, primary: Color.fromARGB(255, 0, 84, 152)),
                                          datePickerTheme: const DatePickerThemeData(
                                            headerBackgroundColor: Color.fromARGB(255, 0, 84, 152),
                                            backgroundColor: Colors.white,
  ...
  showLoaderDialog(BuildContext context) {
    AlertDialog alert = AlertDialog(
      content: Row(
        children: [
          const CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Color.fromARGB(255, 0, 84, 152))),
          Container(
